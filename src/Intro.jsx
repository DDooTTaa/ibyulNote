...
const Input = styled.input`
  border: none;
  border-bottom: 2px solid #eedeb5; /* 하얀색 밑줄 */
  background: transparent;
  color: #eedeb5;
  font-size: 16px;
  padding: 8px 0;
  ...
  &:focus {
    border-bottom: 2px solid #cc7b32; /* 포커스 시 밑줄 색상 변경 */
  }
`;
...
const GradationWord = styled.div`
  line-height: 130%;
  background: linear-gradient(90deg, #cc7b32 34.84%, #cc7b32 50.39%, #eedeb5 65.64%);
